...
def main():
    print("--------------------------------------------")
    print("  Drive using encodes")
    print("--------------------------------------------")
    ev3.Sound.speak("Drive using encodes").wait()
    ...
    while time_s != 0:
        ...
        if d == 0:
            break
        left_motor.run_to_rel_pos(position_sp=d * 90, speed_sp=sp, stop_action=ev3.Motor.STOP_ACTION_BRAKE)
        left_motor.wait_while(ev3.Motor.STATE_RUNNING)
        right_motor.run_to_rel_pos(position_sp=d * 90, speed_sp=sp, stop_action=ev3.Motor.STOP_ACTION_BRAKE)
