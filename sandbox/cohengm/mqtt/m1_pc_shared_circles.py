...
# DONEDO: 4. Uncomment the code below.  It imports a library and creates a relatively simple class.
...
def main():
    ...
    # DONEDO: 5. Delete the line below (mqtt_client = None) then uncomment the code below.  It creates a real mqtt client.
    #mqtt_client = None
